      ...
      <section className="inner-page">
        <div className="container">
          <div className="selling-points-section">
            <h3 className="heading">Holiday Lets in Cheltenham</h3>
        ...
        <div className="landing-text">
          <div className="container">
            ...
            <FAQAccordion
              heading={"Can we bring pets into the apartment?"}
              content={
                "Although we understand that pets are an important part of any holiday, sadly they are not permitted to stay within our accommodation and if a breach is found then you will be held responsible for the infringement."
              }
            />

            <FAQAccordion
              heading={"What time can we check in?"}
              content={
                "We all want to make the most of our staycations and thankfully our apartments are located in the heart of Cheltenham so that you can enjoy what the town has to offer. Check-in is at 4.00 pm and check-out is at 10.00 am, but you can request an extended time if required and we’ll do our utmost to accommodate. "
              }
            />
