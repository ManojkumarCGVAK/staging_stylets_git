      ...
      <section className="inner-page">
        <div className="container">
          <div className="selling-points-section">
            <h3 className="heading">
              Corporate And Business Lets in Cheltenham
            </h3>
        ...
        <div className="landing-text">
          <div className="container">
            ...
            <FAQAccordion
              heading={"Is Wi-Fi included in the stay?"}
              content={
                "It certainly is. We ensure that all essential home features such as Wi-Fi are included within each of our properties. We always try to ensure the strongest connection possible, but if the connection is lost and out of our hands then we cannot be held liable."
              }
            />
            ...
            <FAQAccordion
              ...
              content={
                "For all of our properties, our standard check-in time is 4.00 pm on the day of arrival and must be vacated by 10.00 am on the day of departure. However, if you need to request an earlier check-in or later check-out time then we will do our utmost to accommodate."
              }
            />
